    ...
    <footer className='flexCenter mb-24'>
      <div className="padding-container max-container flex w-full flex-col gap-14">
        <div className="flex flex-col justify-center items-start gap-[10%] md:flex-row">
          ...
          <Image src="/Reise ..png" alt="logos" width={74} height={29}/>
          </Link>
              ...
              <FooterColumn title={FOOTER_CONTACT_INFO.title}>
                {FOOTER_CONTACT_INFO.links.map((link) => (
                  <Link href="/" key={link.label} className="flex gap-4 md:flex-col lg:flex-row">
                    ...
                    <p className="medium-14 whitespace-nowrap text-slate-400">
                      {link.value}
                    </p>
                  </Link>
                ))}
        ...
        <div>
        <p className="regular-14 w-full text-center text-slate-200">2024 Developed By Rafael</p>
      </div>
      </div>
    </footer>
  )
